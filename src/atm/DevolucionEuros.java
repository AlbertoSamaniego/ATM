 ...
 * @author Alberto
 */
public class DevolucionEuros extends JFrame {

    public DevolucionEuros(int cantidad) {
        ...
        if (billete50 == 1 && billete20 == 0 && billete10 == 0 && billete5 == 0) {
            billete50 = 0;
            billete20 = 1;
            billete10 = 2;
            billete5 = 2;
        ...
        for (int i = 0; i < billete20; i++) {
            ImageIcon billete20Icon = new ImageIcon("./src/ATM_Images/20Euros.png");
        ...
        for (int i = 0; i < billete10; i++) {
            ImageIcon billete10Icon = new ImageIcon("./src/ATM_Images/10Euros.png");
        ...
        for (int i = 0; i < billete5; i++) {
            ImageIcon billete5Icon = new ImageIcon("./src/ATM_Images/5Euros.png");
    ...
    public static void main(String[] args) {
        int cantidad = 0;
        new DevolucionEuros(cantidad).setVisible(true);
    }
